function varargout = GuiFisSugeno_201084ShofiaNabilaA_KlsAP(varargin)
%GUIFISSUGENO_201084SHOFIANABILAA_KLSAP M-file for GuiFisSugeno_201084ShofiaNabilaA_KlsAP.fig
%      GUIFISSUGENO_201084SHOFIANABILAA_KLSAP, by itself, creates a new GUIFISSUGENO_201084SHOFIANABILAA_KLSAP or raises the existing
%      singleton*.
%
%      H = GUIFISSUGENO_201084SHOFIANABILAA_KLSAP returns the handle to a new GUIFISSUGENO_201084SHOFIANABILAA_KLSAP or the handle to
%      the existing singleton*.
%
%      GUIFISSUGENO_201084SHOFIANABILAA_KLSAP('Property','Value',...) creates a new GUIFISSUGENO_201084SHOFIANABILAA_KLSAP using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to GuiFisSugeno_201084ShofiaNabilaA_KlsAP_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GUIFISSUGENO_201084SHOFIANABILAA_KLSAP('CALLBACK') and GUIFISSUGENO_201084SHOFIANABILAA_KLSAP('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GUIFISSUGENO_201084SHOFIANABILAA_KLSAP.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help GuiFisSugeno_201084ShofiaNabilaA_KlsAP

% Last Modified by GUIDE v2.5 11-May-2023 13:44:02

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GuiFisSugeno_201084ShofiaNabilaA_KlsAP_OpeningFcn, ...
                   'gui_OutputFcn',  @GuiFisSugeno_201084ShofiaNabilaA_KlsAP_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before GuiFisSugeno_201084ShofiaNabilaA_KlsAP is made visible.
function GuiFisSugeno_201084ShofiaNabilaA_KlsAP_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for GuiFisSugeno_201084ShofiaNabilaA_KlsAP
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GuiFisSugeno_201084ShofiaNabilaA_KlsAP wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GuiFisSugeno_201084ShofiaNabilaA_KlsAP_OutputFcn(hObject, eventdata, handles)
...
bacaBonus=readfis('fisSugeno_201084ShofiaNA_KLSA.fis');
