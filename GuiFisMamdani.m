function varargout = GuiFisMamdani_201084ShofiaNabilaA_KlsAP(varargin)
% GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP M-file for GuiFisMamdani_201084ShofiaNabilaA_KlsAP.fig
%      GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP, by itself, creates a new GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP or raises the existing
%      singleton*.
%
%      H = GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP returns the handle to a new GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP or the handle to
%      the existing singleton*.
%
%      GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP.M with the given input arguments.
%
%      GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP('Property','Value',...) creates a new GUIFISMAMDANI_201084SHOFIANABILAA_KLSAP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GuiFisMamdani_201084ShofiaNabilaA_KlsAP

% Last Modified by GUIDE v2.5 07-May-2023 21:46:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OpeningFcn, ...
                   'gui_OutputFcn',  @GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GuiFisMamdani_201084ShofiaNabilaA_KlsAP is made visible.
function GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GuiFisMamdani_201084ShofiaNabilaA_KlsAP (see VARARGIN)

% Choose default command line output for GuiFisMamdani_201084ShofiaNabilaA_KlsAP
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GuiFisMamdani_201084ShofiaNabilaA_KlsAP wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = GuiFisMamdani_201084ShofiaNabilaA_KlsAP_OutputFcn(hObject, eventdata, handles) 
