function varargout = fuzzygui(varargin)
% FUZZYGUI M-file for fuzzygui.fig
%      FUZZYGUI, by itself, creates a new FUZZYGUI or raises the existing
%      singleton*.
%
%      H = FUZZYGUI returns the handle to a new FUZZYGUI or the handle to
%      the existing singleton*.
%
%      FUZZYGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FUZZYGUI.M with the given input arguments.
%
%      FUZZYGUI('Property','Value',...) creates a new FUZZYGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before fuzzygui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to fuzzygui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help fuzzygui

% Last Modified by GUIDE v2.5 04-May-2023 15:34:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @fuzzygui_OpeningFcn, ...
                   'gui_OutputFcn',  @fuzzygui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before fuzzygui is made visible.
function fuzzygui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to fuzzygui (see VARARGIN)

% Choose default command line output for fuzzygui
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes fuzzygui wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = fuzzygui_OutputFcn(hObject, eventdata, handles) 
...
plot(x,handles.mfHS,'LineWidht',2,'Color','black');
...
HtngBonus=readfis('sifbonusPrak1IvanSA181810101082.fis');
...
if handles.crisp<=10
    set(handles.text28,'String','Bonus Sedikit');
end
if ((handles.crisp>10)&&(handles.crisp<20))
    set(handles.text28,'String','Bonus Sedang');
end
if handles.crisp>=20
    set(handles.text28,'String','Bonus Banyak');
end
